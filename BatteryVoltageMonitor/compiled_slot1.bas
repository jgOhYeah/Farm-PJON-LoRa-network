...
'----UPDATED AT 02:00PM, May 31, 2023----
...
init:
	...
	setfreq m32
;#sertxd("Battery voltage monitor and fence control", " ",    "v2.0.1" , " MAIN", cr,lf, "Jotham Gates, Compiled ", "31-05-2023", cr, lf) 'Evaluated below
w6 = 0
w7 = 89
...
table 0, ("Battery voltage monitor and fence control"," ","v2.0.1"," MAIN",cr,lf,"Jotham Gates, Compiled ","31-05-2023",cr,lf) ;#sertxd
