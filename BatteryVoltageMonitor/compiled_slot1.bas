...
table 89, ("Sent packet",cr,lf) ;#sertxd
table 102, (" iterations",cr,lf) ;#sertxd
table 115, ("Timed reset",cr,lf) ;#sertxd
table 128, ("Valid packet received",cr,lf) ;#sertxd
table 151, ("Fence ") ;#sertxd
table 157, ("Off",cr,lf) ;#sertxd
table 162, ("On",cr,lf) ;#sertxd
table 166, ("Transmit ") ;#sertxd
table 175, ("Off",cr,lf) ;#sertxd
table 180, ("On",cr,lf) ;#sertxd
table 184, ("Transmit interval is ") ;#sertxd
table 205, (" *3 minutes",cr,lf) ;#sertxd
...
table 326, ("Sending state",cr,lf) ;#sertxd
table 341, (" (*0.1) V",cr,lf) ;#sertxd
table 352, ("*0.1 C",cr,lf) ;#sertxd
table 360, ("Fence: ") ;#sertxd
table 367, ("Transmit: ") ;#sertxd
table 377, ("TX Interval: ") ;#sertxd
table 390, ("LoRa dropped out.") ;#sertxd
table 407, ("Will reset and have another go.",cr,lf,cr,lf) ;#sertxd
