...
init:
	...
	setfreq m32
;#sertxd("Battery voltage monitor and fence control", " ",    "v2.0.3" , " MAIN", cr,lf, "Jotham Gates, Compiled ", "31-12-2024", cr, lf) 'Evaluated below
w6 = 0
w7 = 89
...
table 0, ("Battery voltage monitor and fence control"," ","v2.0.3"," MAIN",cr,lf,"Jotham Gates, Compiled ","31-12-2024",cr,lf) ;#sertxd
