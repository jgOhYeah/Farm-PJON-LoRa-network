...
'----UPDATED AT 08:47PM, January 01, 2025----
...
init:
	...
	setfreq m32
;#sertxd("Battery voltage monitor and fence control", " ",    "v2.0.3" , " MAIN", cr,lf, "Jotham Gates, Compiled ", "01-01-2025", cr, lf) 'Evaluated below
w6 = 0
w7 = 89
...
table 0, ("Battery voltage monitor and fence control"," ","v2.0.3"," MAIN",cr,lf,"Jotham Gates, Compiled ","01-01-2025",cr,lf) ;#sertxd
