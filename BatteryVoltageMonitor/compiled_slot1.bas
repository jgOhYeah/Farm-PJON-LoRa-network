...
init:
	...
	setfreq m32
;#sertxd("Battery voltage monitor and fence control", " ",    "v2.0.2" , " MAIN", cr,lf, "Jotham Gates, Compiled ", "20-06-2023", cr, lf) 'Evaluated below
w6 = 0
w7 = 89
...
table 0, ("Battery voltage monitor and fence control"," ","v2.0.2"," MAIN",cr,lf,"Jotham Gates, Compiled ","20-06-2023",cr,lf) ;#sertxd
