...
'----UPDATED AT 01:57PM, February 22, 2023----
...
; Autogenerated by calculations.py at 2023-02-22 13:57:28
...
table 51, ("LoRa Failed",cr,lf) ;#sertxd
table 64, ("LoRa Started",cr,lf) ;#sertxd
table 78, ("Sent packet",cr,lf) ;#sertxd
table 91, (" iterations",cr,lf) ;#sertxd
table 104, ("Timed reset",cr,lf) ;#sertxd
table 117, ("Valid packet received",cr,lf) ;#sertxd
table 140, ("Fence ") ;#sertxd
table 146, ("Off",cr,lf) ;#sertxd
table 151, ("On",cr,lf) ;#sertxd
table 155, ("Transmit ") ;#sertxd
table 164, ("Off",cr,lf) ;#sertxd
table 169, ("On",cr,lf) ;#sertxd
table 173, ("Transmit interval is ") ;#sertxd
table 194, (" *3 minutes",cr,lf) ;#sertxd
table 207, ("invalid. Ignoring",cr,lf) ;#sertxd
table 226, ("Status",cr,lf) ;#sertxd
table 234, ("Resetting",cr,lf) ;#sertxd
table 245, ("Bad code",cr,lf) ;#sertxd
table 255, ("Field ") ;#sertxd
table 261, (" unkown",cr,lf) ;#sertxd
table 270, ("Replying with status",cr,lf) ;#sertxd
table 292, ("Invalid packet recieved. Ignoring",cr,lf) ;#sertxd
table 327, ("Sending state",cr,lf) ;#sertxd
table 342, (" (*0.1) V",cr,lf) ;#sertxd
table 353, ("*0.1 C",cr,lf) ;#sertxd
table 361, ("Fence: ") ;#sertxd
table 368, ("Transmit: ") ;#sertxd
table 378, ("TX Interval: ") ;#sertxd
table 391, ("LoRa dropped out.") ;#sertxd
table 408, ("Reconnected ok") ;#sertxd
table 422, ("Could not reconnect") ;#sertxd
