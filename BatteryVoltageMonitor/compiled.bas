...
'----UPDATED AT 04:49PM, February 21, 2023----
...
; Autogenerated by calculations.py at 2023-02-21 16:49:55
...
;#sertxd(" iterations", cr, lf) 'Evaluated below
w6 = 100
w7 = 112
gosub print_table_sertxd
...
table 100, (" iterations",cr,lf) ;#sertxd
table 113, ("Timed reset",cr,lf) ;#sertxd
table 126, ("Entering receive mode",cr,lf) ;#sertxd
table 149, ("Valid packet received",cr,lf) ;#sertxd
table 172, ("Fence ") ;#sertxd
table 178, ("Off",cr,lf) ;#sertxd
table 183, ("On",cr,lf) ;#sertxd
table 187, ("Transmit ") ;#sertxd
table 196, ("Off",cr,lf) ;#sertxd
table 201, ("On",cr,lf) ;#sertxd
table 205, ("Transmit interval is ") ;#sertxd
table 226, (" *3 minutes",cr,lf) ;#sertxd
table 239, ("invalid. Ignoring",cr,lf) ;#sertxd
table 258, ("Status",cr,lf) ;#sertxd
table 266, ("Resetting",cr,lf) ;#sertxd
table 277, ("Field ") ;#sertxd
table 283, (" unkown",cr,lf) ;#sertxd
table 292, ("Replying with status",cr,lf) ;#sertxd
table 314, ("Finished",cr,lf,cr,lf) ;#sertxd
table 326, ("Invalid packet recieved. Ignoring",cr,lf) ;#sertxd
table 361, ("Entering sleep mode",cr,lf) ;#sertxd
table 382, ("Sending state",cr,lf) ;#sertxd
table 397, ("Batt is: ") ;#sertxd
table 406, (" (*0.1) V",cr,lf) ;#sertxd
table 417, ("*0.1 C",cr,lf) ;#sertxd
table 425, ("Fence: ") ;#sertxd
table 432, ("Transmit: ") ;#sertxd
table 442, ("TX Interval: ") ;#sertxd
table 455, ("LoRa dropped out.") ;#sertxd
table 472, ("Reconnected ok") ;#sertxd
table 486, ("Could not reconnect") ;#sertxd
