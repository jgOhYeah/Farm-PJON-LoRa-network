...
'----UPDATED AT 10:06PM, June 20, 2023----
...
init:
	...
	setfreq m32
	high LED_PIN
;#sertxd("Battery voltage monitor and fence control", " ", "v2.0.2" , " BOOTLOADER", cr,lf, "Jotham Gates, Compiled ", "20-06-2023", cr, lf, "Seeing as I have lots of space in the bootloader section, here is a URL to look at:", cr, lf, "https://github.com/jgOhYeah/Farm-PJON-LoRa-network", cr, lf) 'Evaluated below
w6 = 0
w7 = 232
...
table 0, ("Battery voltage monitor and fence control"," ","v2.0.2"," BOOTLOADER",cr,lf,"Jotham Gates, Compiled ","20-06-2023",cr,lf,"Seeing as I have lots of space in the bootloader section, here is a URL to look at:",cr,lf,"https://github.com/jgOhYeah/Farm-PJON-LoRa-network",cr,lf) ;#sertxd
