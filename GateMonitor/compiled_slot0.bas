...
'----UPDATED AT 11:36PM, December 31, 2024----
...
init:
	...
	setfreq m32
	high LED_PIN
;#sertxd("Battery voltage monitor and fence control", " ", "v2.0.2" , " BOOTLOADER", cr,lf, "Jotham Gates, Compiled ", "31-12-2024", cr, lf, "Seeing as I have lots of space in the bootloader section, here is a URL to look at:", cr, lf, "https://github.com/jgOhYeah/Farm-PJON-LoRa-network", cr, lf) 'Evaluated below
w6 = 0
w7 = 232
...
table 0, ("Battery voltage monitor and fence control"," ","v2.0.2"," BOOTLOADER",cr,lf,"Jotham Gates, Compiled ","31-12-2024",cr,lf,"Seeing as I have lots of space in the bootloader section, here is a URL to look at:",cr,lf,"https://github.com/jgOhYeah/Farm-PJON-LoRa-network",cr,lf) ;#sertxd
